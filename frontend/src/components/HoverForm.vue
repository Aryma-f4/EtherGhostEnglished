    ...
    <div class="hover-form">
      ...
      <form action="" class="hover-form-form" ref="form">
        ...
        <div class="hover-form-line">
          <input class="hover-form-button" type="button" value="Cancel" @click="onClickCancel">
          <input class="hover-form-button" type="button" value="Confirm" @click="onClickConfirm">
        </div>
      </form>
    </div>
  </div>
